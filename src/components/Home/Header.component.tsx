export default function Header() {
    return (
        ...
        <header className="text-center py-20 bg-gray-900 rounded-lg mt-4">
            ...
            <a href="#contact" className="mt-8 inline-block bg-blue-500 text-white py-3 px-6 rounded-full text-lg font-medium hover:bg-blue-600 transition">Contactez-moi</a>
        </header>
    )
}
